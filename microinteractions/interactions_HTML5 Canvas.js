...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(5).to({startPosition:0},0).to({scaleX:1.1428,scaleY:0.7143,x:399.95,y:470.3},4).to({scaleX:0.8571,scaleY:1.1428,x:400,y:410},6).to({scaleX:1.1428,scaleY:0.7143,x:399.95,y:470.3},8).to({scaleX:1,scaleY:1,x:400,y:410},3).wait(3));
...
// library properties:
lib.properties = {
	id: '4083A4C9B16443A58F5203C7713C1CF0',
	width: 800,
	height: 600,
	fps: 24,
	color: "#666699",
...
an.compositions['4083A4C9B16443A58F5203C7713C1CF0'] = {
